...
func (dp *deploymentProcessor) getResourceDataByID(ctx context.Context, resourceID resources.ID) (ResourceData, error) {
	...
	case strings.ToLower(corerp_dm.ContainerResourceType):
		...
		return dp.buildResourceDependency(resourceID, obj.Properties.Application, obj, obj.Properties.Status.OutputResources, obj.ComputedValues, obj.SecretValues, map[string]any{}, portableresources.RecipeData{})
	...
	default:
		...
		return dp.buildResourceDependency(resourceID, obj.ResourceMetadata().ApplicationID(), obj, obj.OutputResources(), map[string]any{}, map[string]rpv1.SecretValueReference{}, outputVariables, portableresources.RecipeData{})
	}
}
