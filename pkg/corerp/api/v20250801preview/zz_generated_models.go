...
type ApplicationGraphResource struct {
	...
	// of this map varies by type (e.g. a Radius.Compute/containers resource exposes
	// different keys than Radius.Datastores/redisCaches or any user-defined resource type) and matches the properties returned
	// by that resource's GET response. Fields already represented elsewhere in this
	// model (id, type, name, provisioningState, status.outputResources, connections, routes) are omitted. Use diffHash rather
