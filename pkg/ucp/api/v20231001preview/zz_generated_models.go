...
type AwsAccessKeyCredentialProperties struct {
	...
	// CONSTANT; Access Key kind
	// Field has constant value AWSCredentialKindAccessKey, any specified value is ignored.
...
type AwsIRSACredentialProperties struct {
	// CONSTANT; IRSA credential kind
	// Field has constant value AWSCredentialKindIRSA, any specified value is ignored.
	Kind *AWSCredentialKind
...
type AzureServicePrincipalProperties struct {
	...
	// CONSTANT; Service Principal kind
	// Field has constant value AzureCredentialKindServicePrincipal, any specified value is ignored.
	Kind *AzureCredentialKind
...
type AzureWorkloadIdentityProperties struct {
	...
	// CONSTANT; Workload Identity kind
	// Field has constant value AzureCredentialKindWorkloadIdentity, any specified value is ignored.
	Kind *AzureCredentialKind
...
type InternalCredentialStorageProperties struct {
	// CONSTANT; Internal credential storage kind
	// Field has constant value CredentialStorageKindInternal, any specified value is ignored.
	Kind *CredentialStorageKind
...
// LocationResourceTypeAPIVersion - The configuration for an API version of an resource type.
type LocationResourceTypeAPIVersion struct {
}
...
// ResourceProviderSummaryLocation - The configuration of a resource provider in a specific location.
type ResourceProviderSummaryLocation struct {
}
